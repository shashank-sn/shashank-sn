...
[**hold your voice**]([http://holdyourvoice.com](https://github.com/shashank-sn/holdyourvoice)) came from a different frustration. ai kept flattening everything into the same texture. founders who had real voice were publishing content that sounded like a press release written by a committee. hyv is the tool that catches the problem before it ships — score, highlight, rewrite. your voice, enforced. (open source)
